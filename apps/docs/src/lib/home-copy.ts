...
export const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    lead: 'UI that stays yours. Thirty-two accessible components, plain CSS, and a token system you can re-skin with one variable — from a weekend project to a design system with its own opinions.',
  ...
  th: {
    ...
    lead: 'UI ที่ยังเป็นของคุณ — คอมโพเนนต์ที่เข้าถึงง่าย 32 ตัว, CSS ธรรมดา และระบบ token ที่เปลี่ยนหน้าตาทั้งระบบได้ด้วยตัวแปรเดียว ตั้งแต่โปรเจกต์เล็กๆ ไปจนถึงดีไซน์ซิสเทมที่มีจุดยืนของตัวเอง',
